...
## Project Structure
    ...
    ├── lightning_roadside_32548  # Django project configurations
...
1. Clone this repo and `cd lightning_roadside_32548`
...
2. Clone this repo and `cd lightning_roadside_32548`
